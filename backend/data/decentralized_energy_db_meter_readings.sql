...
CREATE TABLE `meter_readings` (
  ...
  `net_energy` decimal(10,2) GENERATED ALWAYS AS ((`energy_generated` - `energy_consumed`)) STORED,
  PRIMARY KEY (`reading_id`),
  KEY `meter_id` (`meter_id`),
  CONSTRAINT `meter_readings_ibfk_1` FOREIGN KEY (`meter_id`) REFERENCES `smart_meters` (`meter_id`)
