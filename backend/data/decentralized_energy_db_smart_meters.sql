...
CREATE TABLE `smart_meters` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `smart_meters_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
...
LOCK TABLES `smart_meters` WRITE;
/*!40000 ALTER TABLE `smart_meters` DISABLE KEYS */;
/*!40000 ALTER TABLE `smart_meters` ENABLE KEYS */;
UNLOCK TABLES;
