...
CREATE TABLE `trade_orders` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `trade_orders_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
...
LOCK TABLES `trade_orders` WRITE;
/*!40000 ALTER TABLE `trade_orders` DISABLE KEYS */;
/*!40000 ALTER TABLE `trade_orders` ENABLE KEYS */;
UNLOCK TABLES;
